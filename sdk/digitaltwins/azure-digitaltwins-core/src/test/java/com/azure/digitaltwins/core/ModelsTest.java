...
public class ModelsTest extends ModelsTestBase {
    ...
    public void modelLifecycleTest(HttpClient httpClient, DigitalTwinsServiceVersion serviceVersion) {
        ...
        createModelsRunner(client, (modelsList) -> {
            List<ModelData> createdModelsPagedIterable = client.createModels(modelsList);
    ...
    public void createModelThrowsIfModelAlreadyExists(HttpClient httpClient, DigitalTwinsServiceVersion serviceVersion) {
        ...
        final String wardModelId = UniqueIdHelper.getUniqueModelId(TestAssetDefaults.wardModelId, client);
    ...
    private static void createModelsRunner(DigitalTwinsClient client, Consumer<List<String>> createModelsTestRunner) {
        String buildingModelId = UniqueIdHelper.getUniqueModelId(TestAssetDefaults.buildingModelId, client);
        String floorModelId = UniqueIdHelper.getUniqueModelId(TestAssetDefaults.floorModelId, client);
        String hvacModelId = UniqueIdHelper.getUniqueModelId(TestAssetDefaults.hvacModelId, client);
        String wardModelId = UniqueIdHelper.getUniqueModelId(TestAssetDefaults.wardModelId, client);
